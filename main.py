...
for i in range(num_frames):
    ...
    if curr_row['object presence'] == 1:
        ...
        frame, td = form_frame.form_frame(filename, start_time, frame_time)
        median_filtered_frame = median(frame, disk(3), mode='constant', cval=0.0)
        ...
        axs.imshow(median_filtered_frame)
        ...
        file_path = 'final_images/'+num_str+'.jpg'
...
# video_data_extraction.show_td(td)
